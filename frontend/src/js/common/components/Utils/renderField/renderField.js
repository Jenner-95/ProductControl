...
export const renderCurrencyDolar = ({
    input, meta: { touched, error }, prefix = "$ ", placeholder, disabled, className = 'form-control',
}) => {
    const invalid = touched && error;
    return (
        <div>
...
const colourStyles = {
    ...
    option: (styles, { data, isDisabled, isFocused, isSelected }) => {
      ...
      return {
        ...styles,
        backgroundColor: isDisabled ? 'red' : isSelected ? '#E1E1E1':'fff' ,
        color: isSelected ?'#227093':'black',
        cursor: isDisabled ? 'not-allowed' : '#227093   ',
      };
    },
  };
